...
Write two artifacts under `./.skill/ppt-master/projects/`:

| Artifact | Path |
|---|---|
| Research supplement | `./.skill/ppt-master/projects/<research_slug>.md` |
| Fact provenance | `./.skill/ppt-master/projects/<research_slug>.facts.json` |

**Hard rule — location and preservation**: write both files under `./.skill/ppt-master/projects/`, never the repository root. Do not overwrite an existing user file; choose a new research stem instead. This stage creates no image folder.
...
```bash
python3 ${SKILL_DIR}/scripts/project_manager.py import-sources ./.skill/ppt-master/projects/<project_name> [<source_paths...>] ./.skill/ppt-master/projects/<research_slug>.md ./.skill/ppt-master/projects/<research_slug>.facts.json
```
...
- [x] Research supplement: `./.skill/ppt-master/projects/<research_slug>.md` (N declared gaps covered)
- [x] Fact provenance: `./.skill/ppt-master/projects/<research_slug>.facts.json` (N external facts)
