...
| Pattern | Example |
|---|---|
| "继续生成 .claude/ppt-master/projects/<project_name>" | "继续生成 .claude/ppt-master/projects/ppt169_joe_hisaishi" |
| "resume execution .claude/ppt-master/projects/<project_name>" | "resume execution .claude/ppt-master/projects/ppt169_joe_hisaishi" |
| Project path + any "继续 / 恢复 / 继续做 / 接着做" semantic | "把 .claude/ppt-master/projects/ppt169_joe_hisaishi 继续做完" |
