...
Usage:
    python3 scripts/project_manager.py init <project_name> [--format ppt169] [--dir .skill/ppt-master/projects]
...
class ProjectManager:
    ...
    def __init__(self, base_dir: str = ".skill/ppt-master/projects") -> None:
...
def parse_init_args(argv: list[str]) -> tuple[str, str, str]:
    ...
    base_dir = ".skill/ppt-master/projects"
